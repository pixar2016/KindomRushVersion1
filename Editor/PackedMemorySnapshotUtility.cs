...
public static class PackedMemorySnapshotUtility
{
    ...
    static void SaveToFile(string filePath, PackedMemorySnapshot snapshot)
    {
        ...
        UnityEngine.Profiler.BeginSample("PackedMemorySnapshotUtility.SaveToFile");
        stopwatch.Start();
    ...
    static PackedMemorySnapshot LoadFromFile(string filePath)
    {
        ...
        if (string.Equals(fileExtension, ".memsnap3", System.StringComparison.OrdinalIgnoreCase)) {
            UnityEngine.Profiler.BeginSample("PackedMemorySnapshotUtility.LoadFromFile(litjson)");
            stopwatch.Start();
        ...
        {
            UnityEngine.Profiler.BeginSample("PackedMemorySnapshotUtility.LoadFromFile(json)");
            stopwatch.Start();
        ...
        {
            UnityEngine.Profiler.BeginSample("PackedMemorySnapshotUtility.LoadFromFile(binary)");
            stopwatch.Start();
